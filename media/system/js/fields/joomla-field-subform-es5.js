...
(function (customElements) {
  ...
  function (_HTMLElement) {
    ...
    function JoomlaFieldSubform() {
      ...
      _this.lastRowNum = _this.getRows().length; // Template for the repeating group
    ...
    _createClass(JoomlaFieldSubform, [{
      ...
      value: function fixUniqueAttributes(row, count) {
        ...
        var basename = row.getAttribute('data-base-name'); // group base name, without count

        var countnew = Math.max(this.lastRowNum, count);
