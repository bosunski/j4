...
document.addEventListener('DOMContentLoaded', () => {
  ...
  modulesLinks.forEach(modulesLink => {
    modulesLink.addEventListener('click', event => {
      ...
      window.parent.Joomla.editors.instances[editor].replaceSelection(`{loadmodule ${type},${name}}`); // Close the modal
  ...
  positionsLinks.forEach(positionsLink => {
    positionsLink.addEventListener('click', event => {
      ...
      window.parent.Joomla.editors.instances[editor].replaceSelection(`{loadposition ${position}}`); // Close the modal
