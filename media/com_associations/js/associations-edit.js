  ...
  Joomla.hideAssociation = function (formControl, languageCode) {
    ...
    controlGroup.forEach(function (element) {
      ...
      if (el) {
        ...
        if (attribute.replace('_id', '') === "".concat(formControl, "_associations_").concat(languageCode.replace('-', '_'))) {
    ...
    if (formControlLanguage) {
      formControlLanguage.addEventListener('change', function (event) {
        ...
        controlGroup.forEach(function (element) {
          ...
          var languageCode = attribute.replace('_id', '').replace('jform_associations_', ''); // Show the association fields
